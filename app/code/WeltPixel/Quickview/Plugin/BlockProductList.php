...
class BlockProductList
{
        ...
        )
    {
        ...
        if ($isEnabled) {
            ...
            return $result . '<a class="weltpixel-quickview '.$buttonStyle.'" data-quickview-url=' . $productUrl . ' href="javascript:void(0);"><span><em class="porto-icon-eye"></em>' . __("Quickview") . '</span></a>';
        }
